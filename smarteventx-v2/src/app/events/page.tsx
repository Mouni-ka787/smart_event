            ...
            {!loading && !error && (
              <>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {events.map((event) => (
                    <div key={event._id} className="bg-white overflow-hidden shadow-lg rounded-xl hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
                      ...
                      <div className="px-5 py-5">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-sm text-primary-600 font-medium">{event.category}</p>
                          </div>
